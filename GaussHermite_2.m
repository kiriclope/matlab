...
% Gauss-Hermite quadrature of order n>1, on the interval [-INF,
% +INF].
% This function is valid for any degree n>=2, as the companion
% matrix
...
% polynomial
% under consideration. Moreover, CM will be constructed in such a
% way
